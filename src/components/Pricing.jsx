...
const plans = [
  {
    ...
    description:
      "You’re new here, we're not going to take advantage of you yet.",
    button: {
  ...
  },
  {
    ...
    features: [
      'All the same perks as Star',
      'SSL Encrytion',
      'No service limits *limited time only',
      'Buy! Buy! Buy!',
      'Crypto',
    ],
  ...
  },
  {
    ...
    features: [
      'Super Duperstar status',
      'Seven firmaments',
      'Real-time at the speed of light',
      'Unlimited limits',
      'Advanced and basic opportunities',
      'Automation in the least',
    ],
