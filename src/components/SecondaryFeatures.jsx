...
const features = [
  {
    ...
    description:
      'Whether it’s $1 or $1,000,000, es muy correcto',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Build a balanced diet',
    description:
      'Vegetables, fruits (tomato at the least), grains, dairy or non dairy, meat or regular.  Is it just us, or does the food pyramid look awfully rounded these days.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Decisions within 5 business seconds',
    description:
  ...
  },
  {
    ...
    description:
      "That's what the phrase 'Pizza Party' means to millions",
    icon: DeviceListIcon,
  },
  {
    name: 'Secure',
    description:
      "We don't share your decision with anyone.  Anyone who comes knocking, we tell them to 'Get outta here!' Unless is the delivery person, to whom we thank and tip with the generosity of a noble.",
    icon: DeviceLockIcon,
  },
  {
    name: 'Visualization',
