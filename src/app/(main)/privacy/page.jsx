    ...
    return (
        <div className="w-full px-4 flex justify-center">
            <div className="max-w-4xl px-4">
                ...
                <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pizza Accountant.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to Pizza Accountant, accessible from <a href="pizza.accountant" rel="external nofollow noopener" target="_blank">pizza.accountant</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>By visiting this page on our website: <a href="pizza.accountant/contact" rel="external nofollow noopener" target="_blank">pizza.accountant/contact</a></li>
                </ul>
            </div>
        </div>
    )
